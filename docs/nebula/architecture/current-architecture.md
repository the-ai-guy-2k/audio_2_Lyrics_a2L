...
**Authority:** ACI-A2L-SI-PROM-001 promotion of the validated Song Intelligence analyzer baseline (through ACI-A2L-SI-010) to `deployable`. Product-facing operator path remains the ACI-A2L-REL-PROM-004 release-package baseline.
